...
const HeaderHome: React.FC<HeaderHomeProps> = ({ children }) => {
  ...
  return (
    <div className={"h-full bg-gradient-to-t from-transparent to-black"}>
      <div className="min-h-10 flex justify-between py-8 lg:px-12 2xs:px-5 xs:px-8">
        ...
        <div className="relative 2xs:flex md:hidden justify-center items-center">
          ...
          {isOpen && (
            <div className="absolute z-10 left-0 top-12 mt-2 w-56 rounded-md shadow-lg bg-black">
              <div
                className="py-1 px-1"
                role="menu"
              ...
              >
                {navBarItem.map((item) => (
                  <a
                    href="#"
                    className="text-background block px-4 py-2 rounded-lg text-sm text-gray-700 transition duration-300 hover:bg-background hover:text-black"
                    role="menuitem"
                  >
                    {item}
                  </a>
        ...
        <div className="py-2 flex flex-row 2xs:hidden md:flex">
          <a
            href="#"
            className="text-background border border-background px-4 py-2 rounded transition duration-300 hover:bg-background hover:text-secondary hover:scale-110"
          >
            تماس با ما
          </a>
        </div>
